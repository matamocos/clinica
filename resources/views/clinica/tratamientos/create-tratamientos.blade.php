		...
		<form id="form" class="ui form" action="" method="POST">
			...
			<div class="fields">
				...
				<div class="eight wide required field">
					...
					<input type="text" name="fecha_inicio" placeholder="Fecha de inicio" required>
				</div>

				<div class="eight wide field">
					<label>Fecha de finalización</label>
					<input type="text" name="fecha_fin" placeholder="Fecha de finalización">
				</div>
			...
			<div class="fields">
				...
				<div class="six wide required field">
					...
					<select class="ui search dropdown" name="tipo_tratamiento_id" required>
						@foreach($tipos as $t)
